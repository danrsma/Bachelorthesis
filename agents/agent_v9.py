...
async def main():
    ...
    if file_path != "":
        ...
        result2 = llm2.invoke(
            str(user_input)+"\n"+str(result1)+""" Create Blender Code for the described Landscape. Create every Object and Shape with math."""
        )
        print("\n")
        ...
        result2 = llm2.invoke(
            str(user_input)+""" Create Blender Code for the described Landscape. Create every Object and Shape with math."""
        )
        print("\n")
        print("CodeLLM Output:")
        print("\n")
