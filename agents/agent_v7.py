...
class InputApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Required Input: Picture")
...
async def main():
    ...
    result1 = chain.invoke(
        {"text": str(user_input1)+"\n"+"Provide a detailed and extensive description of the image. Describe every object in the picture accurately", "image": image_b64, "image_type": image_type}
    )
    print("\n")
    ...
    result2 = llm2.invoke(
        str(result1)+" Create Blender Code for the described Landscape. Be very detailed about the every Object and the Ground it stands on. Do not create a Sky Object. Do not create a camera.\n"+str(user_input2)
    )
    print("\n")
